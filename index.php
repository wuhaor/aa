...
<html>
    ...
    <nav id="menu">
        <div class="container">
            ...
            <div id="menu3">
                <ul>
                    <li><a href="index.php" class="n">首页</a></li>
                    ...
                    <li><span onclick="creatRequest('denglu.php')" class="nnav">登录/注册</span></li>
                 </ul>
            </div>
	...
	<script type="text/javascript">
		...
		function alertContents() { //处理服务器返回的信息
			if (http_request.readyState == 4) {
				if (http_request.status == 200) {
				    if(urll=="vip.php"||urll=="denglu.php"||urll=="tuijian.php"||urll=="MV.php") document.getElementById("cen1").innerHTML=http_request.responseText;
        ...
        function check(form){
            if(form.user.value=="")
            {alert("用户名、密码不能为空！");form.user.focus();}
            else if(form.pass.value=="")
            {alert("用户名、密码不能为空！");form.pass.focus();}
            else form.submit();
        }
        function change() {
